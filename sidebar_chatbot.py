...
def sidebar_chatbot():
    ...
    if user_input:
        prompt = ChatPromptTemplate.from_messages([
            ("system", "You are a helpful and friendly AI health assistant. Greet the patient by name. Use the full patient record and conversation history to respond accurately and avoid generic output"),
